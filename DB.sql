...
CREATE TABLE `empleados` (
  ...
  PRIMARY KEY (`id`),
  KEY `empleados_ibfk_1_idx` (`hotel_id`),
...
CREATE TABLE `reservas` (
  ...
  PRIMARY KEY (`id`),
  KEY `reservas_ibfk_1_idx` (`hotel_id`),
...
INSERT INTO `reservas` VALUES (1,'Carlos García',2,'2024-04-15','2024-04-20',1,'123456789'),(2,'Laura Martínez',1,'2024-05-10','2024-05-15',2,'987654321'),(3,'Roberto Jiménez',4,'2024-06-20','2024-06-25',3,'654321987');
...
INSERT INTO `rol` VALUES (1,'ADMINISTRADOR',1),(2,'CLIENTE',2),(6,'CLIENTE',3),(7,'CLIENTE',1);
...
INSERT INTO `usuario` VALUES (1,'juan','$2a$10$P1.w58XvnaYQUQgZUCk4aO/RTRl8EValluCqB3S2VMLTbRt.tlre.','Juan','Castro Mora'),(2,'rebeca','$2a$10$GkEj.ZzmQa/aEfDmtLIh3udIH5fMphx/35d0EYeqZL5uzgCJ0lQRi','Rebeca','Contreras Mora'),(3,'pedro','$2a$10$koGR7eS22Pv5KdaVJKDcge04ZB53iMiw76.UjHPY.XyVYlYqXnPbO','Pedro','Mena Loria');
...
-- Dump completed on 2024-04-17 20:51:55
